...
#'
#' The package \pkg{spTest} implements nonparametric hypothesis tests of isotropy and symmetry in spatial data. The available functions are \code{\link{LuTest}},\code{\link{GuanTestGrid}}, \code{\link{GuanTestUnif}}, and \code{\link{MaityTest}}.
#' @references \itemize{
